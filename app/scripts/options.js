...
React.render(
  React.createElement("div", null, 
    React.createElement("h1", null, chrome.i18n.getMessage('optionTitle')), 
    React.createElement("p", {dangerouslySetInnerHTML: {__html: chrome.i18n.getMessage('optionDescription')}})
  ),
